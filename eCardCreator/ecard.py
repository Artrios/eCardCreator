...
def cardmaker():
    if request.method == 'POST':
        ...
        eCardCreator.regionalize.regionalize(f"build/{request.form['TrainerName']}.asm",f"build/{request.form['TrainerName']}-{request.form['language']}.tx",request.form['language'],request.form['language'])
        ...
        eCardCreator.stripgbc.stripgbc(f"build/{request.form['TrainerName']}-{request.form['language']}.gbc", f"build/{request.form['TrainerName']}-{request.form['language']}.bin")
        eCardCreator.checksum.checksum(f"build/{request.form['TrainerName']}-{request.form['language']}.bin", f"build/{request.form['TrainerName']}-{request.form['language']}.mev")
        eCardCreator.ereadertext.ereadertext(f"build/{request.form['TrainerName']}-card.asm", f"build/{request.form['TrainerName']}-card-{request.form['language']}.tx", request.form['language'])

        #subprocess.run(["python3", "build/scripts/regionalize.py", "build/prologue.asm", "build/prologue-EN.tx", "EN", "EN"])
        eCardCreator.regionalize.regionalize("build/prologue.asm",f"build/prologue-{request.form['language']}.tx",request.form['language'],request.form['language'])
        ...
        eCardCreator.stripgbc.stripgbc(f"build/prologue-{request.form['language']}.gbc", f"build/prologue-{request.form['language']}.bin")
        ...
        eCardCreator.ereadertext.ereadertext("build/battletrainer.asm", f"build/battletrainer-{request.form['language']}.tx", request.form['language'])
        ...
        eCardCreator.stripgbc.stripgbc(f"build/{request.form['TrainerName']}-card-{request.form['language']}.gbc", f"build/{request.form['TrainerName']}-card-{request.form['language']}.z80")
